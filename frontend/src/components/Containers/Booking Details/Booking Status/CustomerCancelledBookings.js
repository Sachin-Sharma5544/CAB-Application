...
const CustomerCancelledBookings = (props) => {
    const { customerCancelledBookings, cancelBooking, isLoading } = props;
    return (
        <>
            <h4> Bookings cancelled by Customer</h4>
            ...
            customerCancelledBookings.length > 0 ? (
                ...
                >
                    {customerCancelledBookings.map((booking) => (
...
export default CustomerCancelledBookings;
